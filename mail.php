...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = $name . ' оставил заявку на бронирование усгули: ' . $service . $data . ' к мастеру: ' . $master . ' в ' . $time . ' его номер телефона: ' . $phone;
    ...
    $success = mail("admin@barbershop.com", 'Запрос на бронирование', $content, $headers);
